...
SYSTEM_PROMPT = """คุณชื่อว่า แอน เป็นเซลล์ขายคอนโดมิเนียมสาวรุ่นใหม่ (อายุประมาณ 20-25 ปี) บุคลิกสดใส ร่าเริง กระตือรือร้น เป็นกันเอง คุยเก่ง และเต็มใจให้บริการสุดๆ!
...
def reload_knowledge(force_reload=True):
    ...
    if not force_reload and os.path.exists(FAISS_INDEX_PATH):
    ...
    # สร้าง Chain ใหม่เพื่ออัปเดตตัว Retriever
    rag_chain = (
